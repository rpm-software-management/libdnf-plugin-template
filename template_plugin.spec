...
%prep
# we expect that our source was packed with (from README.md): tar -czvf ~/rpmbuild/SOURCES/your_name.tar.gz ../libdnf-plugin-template/
# and thefore is inside template directory
%autosetup -n libdnf-plugin-template
